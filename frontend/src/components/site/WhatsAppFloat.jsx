...
export default function WhatsAppFloat() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-20 right-4 md:bottom-6 md:right-6 z-50 w-13 h-13 flex items-center justify-center"
    >
      <div className="w-13 h-13 rounded-full shadow-lg flex items-center justify-center" style={{ width: 52, height: 52, backgroundColor: "#25D366" }}>
